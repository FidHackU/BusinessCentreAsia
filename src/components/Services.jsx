    ...
    <section id="services" className="pt-8 pb-16 lg:pt-16 lg:pb-32 bg-primary relative border-t border-slate-800">
      <div className="max-w-[1200px] mx-auto px-6 relative z-10 w-full overflow-hidden md:overflow-visible">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 lg:mt-16"
        >
          {services.map((service, i) => (
            <div
              key={i}
              className="glass-card p-6 md:p-8 group relative overflow-hidden flex flex-col bg-slate-900/50 border-slate-700/50"
            >
